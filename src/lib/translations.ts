...
export const translations: Record<Lang, Translation> = {
  sl: {
    ...
    gallery: {
      title: "Galerija",
      subtitle: "Fotografije hiše — zunaj in znotraj.",
      alts: [
        "Zunanjost počitniške hiše Cottage Kobarid s teraso in vrtom ob gozdu",
        "Vhod v počitniško hišo Kobarid s cvetjem in sedeži pred hišo",
        "Pogled iz zraka na počitniško hišo Kobarid in vrtne terase",
        "Pogled iz zraka na počitniško hišo v Kobaridu z zgornjo teraso za počitek",
        "Pogled na počitniško hišo Kobarid in dolino z razgledom na okoliške gore",
        "Razgled iz počitniške hiše v Kobaridu na gore in okoliške hiše",
        "Zgornja vrtna terasa počitniške hiše Kobarid z ležalnikom in stopnicami",
        "Vrtni lounge in zunanji žar ob počitniški hiši v Kobaridu",
        "Pokrita terasa počitniške hiše Cottage Kobarid z mizo in stoli",
        "Pergola s sedežno garnituro pri počitniški hiši Kobarid in pogledom na gore",
        "Kurišče ob počitniški hiši Kobarid z razgledom na dolino Soče",
        "Zgornja razgledna terasa počitniške hiše Kobarid z lesenimi stoli",
        "Jedilni kotiček in kuhinja v počitniški hiši Cottage Kobarid",
        "Dnevni prostor počitniške hiše Kobarid z mizo, klopmi in kotno sedežno garnituro",
        "Svetel dnevni prostor počitniške hiše v Kobaridu z leseno jedilno mizo",
        "Dnevni prostor počitniške hiše Cottage Kobarid s stopnicami v mansardo",
        "Kompaktna kuhinja počitniške hiše v Kobaridu z indukcijsko ploščo in pečico",
        "Moderna kuhinja v počitniški hiši Cottage Kobarid z lesenimi površinami",
        "Kopalnica počitniške hiše v Kobaridu z umivalnikom in WC-jem",
        "Pralni stroj v kopalnici počitniške hiše Cottage Kobarid",
        "Mansardna spalnica počitniške hiše v Kobaridu s štirimi posteljami",
        "Mansardna spalnica počitniške hiše Cottage Kobarid z več ležišči in otroško posteljico",
        "Podstrešna spalnica v počitniški hiši Kobarid z enojnimi in zakonskimi posteljami",
        "Družinska spalnica v mansardi počitniške hiše Cottage Kobarid",
      ],
    },
    hero: {
    ...
    about: {
      title: "Cottage Kobarid — počitniška hiša za najem",
  ...
  hr: {
    ...
    gallery: {
      title: "Galerija",
      subtitle: "Fotografije kuće — izvana i iznutra.",
      alts: [
        "Vanjski izgled kuće za odmor Cottage Kobarid s terasom i vrtom uz šumu",
        "Ulaz u kuću za odmor Kobarid s cvijećem i sjedalima ispred kuće",
        "Pogled iz zraka na kuću za odmor Kobarid i vrtne terase",
        "Pogled iz zraka na kuću za odmor u Kobaridu s gornjom terasom za odmor",
        "Pogled na kuću za odmor Kobarid i dolinu s pogledom na okolne planine",
        "Pogled iz kuće za odmor u Kobaridu na planine i okolne kuće",
        "Gornja vrtna terasa kuće za odmor Kobarid s ležaljkom i stepenicama",
        "Vrtni lounge i vanjski roštilj uz kuću za odmor u Kobaridu",
        "Natkrivena terasa kuće za odmor Cottage Kobarid sa stolom i stolicama",
        "Pergola sa sjedećom garniturom kod kuće za odmor Kobarid i pogledom na planine",
        "Ognjište uz kuću za odmor Kobarid s pogledom na dolinu Soče",
        "Gornja terasa s pogledom kuće za odmor Kobarid s drvenim stolicama",
        "Blagovaonski kutak i kuhinja u kući za odmor Cottage Kobarid",
        "Dnevni prostor kuće za odmor Kobarid sa stolom, klupama i kutnom garniturom",
        "Svijetli dnevni prostor kuće za odmor u Kobaridu s drvenim blagovaonskim stolom",
        "Dnevni prostor kuće za odmor Cottage Kobarid sa stepenicama prema potkrovlju",
        "Kompaktna kuhinja kuće za odmor u Kobaridu s indukcijskom pločom i pećnicom",
        "Moderna kuhinja u kući za odmor Cottage Kobarid s drvenim površinama",
        "Kupaonica kuće za odmor u Kobaridu s umivaonikom i WC-om",
        "Perilica rublja u kupaonici kuće za odmor Cottage Kobarid",
        "Potkrovna spavaća soba kuće za odmor u Kobaridu s četiri kreveta",
        "Potkrovna spavaća soba kuće za odmor Cottage Kobarid s više ležajeva i dječjim krevetićem",
        "Potkrovna spavaća soba u kući za odmor Kobarid s jednokrevetnim i bračnim krevetima",
        "Obiteljska spavaća soba u potkrovlju kuće za odmor Cottage Kobarid",
      ],
    },
    hero: {
      title: "Cottage Kobarid",
  ...
  it: {
    ...
    gallery: {
      title: "Galleria",
      subtitle: "Foto della casa — esterni e interni.",
      alts: [
        "Esterno della casa vacanze Cottage Kobarid con terrazza e giardino ai margini del bosco",
        "Ingresso della casa vacanze a Caporetto con fiori e sedute davanti alla casa",
        "Vista aerea della casa vacanze a Caporetto e delle terrazze in giardino",
        "Vista aerea della casa vacanze a Caporetto con terrazza panoramica superiore",
        "Vista della casa vacanze a Caporetto e della valle con le montagne circostanti",
        "Vista dalla casa vacanze a Caporetto sulle montagne e sulle case vicine",
        "Terrazza superiore in giardino della casa vacanze a Caporetto con lettino e scale",
        "Area lounge in giardino e barbecue esterno presso la casa vacanze a Caporetto",
        "Terrazza coperta della casa vacanze Cottage Kobarid con tavolo e sedie",
        "Pergola con salotto presso la casa vacanze a Caporetto e vista sulle montagne",
        "Focolare esterno presso la casa vacanze a Caporetto con vista sulla valle dell'Isonzo",
        "Terrazza panoramica superiore della casa vacanze a Caporetto con sedie in legno",
        "Angolo pranzo e cucina nella casa vacanze Cottage Kobarid",
        "Zona giorno della casa vacanze a Caporetto con tavolo, panche e divano ad angolo",
        "Luminoso soggiorno della casa vacanze a Caporetto con tavolo da pranzo in legno",
        "Zona giorno della casa vacanze Cottage Kobarid con scala verso la mansarda",
        "Cucina compatta della casa vacanze a Caporetto con piano a induzione e forno",
        "Cucina moderna nella casa vacanze Cottage Kobarid con superfici in legno",
        "Bagno della casa vacanze a Caporetto con lavabo e WC",
        "Lavatrice nel bagno della casa vacanze Cottage Kobarid",
        "Camera mansardata della casa vacanze a Caporetto con quattro letti",
        "Camera mansardata della casa vacanze Cottage Kobarid con più posti letto e culla",
        "Camera mansardata nella casa vacanze a Caporetto con letti singoli e matrimoniali",
        "Camera familiare in mansarda della casa vacanze Cottage Kobarid",
      ],
    },
    hero: {
      title: "Cottage Kobarid",
      h1: "Cottage Kobarid — casa vacanze a Caporetto, Valle dell'Isonzo",
      tagline: "Dove l'Isonzo sussurra e le montagne tacciono",
    ...
    about: {
      title: "Cottage Kobarid",
      body1: "La casa vacanze si trova a soli 1 km da Caporetto (Kobarid), sul tranquillo margine del villaggio accanto al bosco. Nel 2021 è stata completamente ristrutturata e arredata con stile moderno, offrendo agli ospiti il massimo comfort per una vacanza rilassata e indimenticabile.",
      ...
      body3: "Al piano terra vi attende un ampio soggiorno con un comodo divano angolare, un tavolo da pranzo con panche e un climatizzatore che garantisce una temperatura piacevole tutto l'anno. La cucina è completamente attrezzata per la preparazione dei pasti e include lavastoviglie, piano cottura a induzione, forno, cappa, scaldabagno e frigorifero con congelatore.",
      body4: "Il bagno è dotato di doccia, lavabo, WC, lavatrice, asciugacapelli e scaldabagno elettrico.",
      body5: "Nella mansarda sono disponibili due comodi letti matrimoniali (150 × 200 cm) e un letto singolo (90 × 200 cm), che consentono un soggiorno confortevole fino a cinque persone. Per maggiore comodità, nella stanza si trovano climatizzatore, armadio guardaroba e lettino per bambini, rendendo l'alloggio adatto anche a famiglie con bambini piccoli.",
      body6: "Per piacevoli momenti all'aperto sono a disposizione una terrazza coperta sul retro della casa, una pergola con divani davanti, un barbecue esterno e uno spazio per sedersi attorno al fuoco. Sulla terrazza superiore potete godervi il caffè del mattino o il tramonto serale circondati da natura incontaminata e panorami mozzafiato.",
      body7: "Caporetto e i suoi dintorni offrono numerose possibilità per trascorrere il tempo libero in modo attivo: noleggio biciclette, rafting, canyoning, parapendio, pesca e molto altro. Gli amanti di una vacanza più tranquilla possono esplorare i sentieri nel bosco o rinfrescarsi nel vicino fiume Natisone (Nadiža).",
    ...
    romantic: {
      title: "Sentite l'anima di Caporetto",
      body1: "Al mattino vi sveglia il mormorio di un ruscello e il profumo dell'aria di montagna. All'orizzonte si stagliano le silhouette delle Alpi Giulie, mentre l'Isonzo (Soča) scorre nella valle nel suo inconfondibile bagliore turchese-verde. Questa è Caporetto — e questa è la vostra casa per questi giorni.",
      ...
      body3: "Di notte, quando le luci si spengono e le stelle brillano sopra Caporetto, capirete perché ci si torna sempre.",
    },
    activities: {
      title: "Cosa potete fare",
      subtitle: "La Valle dell'Isonzo e i dintorni di Caporetto offrono attività per tutte le stagioni e tutti i gusti.",
      items: buildActivities("it"),
    },
    seasons: {
      title: "Quando venire",
      body: "Caporetto vi coccola tutto l'anno. La primavera porta il verde e la piena dell'Isonzo — il momento ideale per il rafting e le prime escursioni in montagna. L'estate è il tempo dei bagnanti, degli avventurieri e di chi cerca frescura sopra il mare di caldo. L'autunno indora i boschi e porta pace — meno turisti, più spazio per voi. L'inverno svela il fascino silenzioso delle montagne innevate e delle piste del Canin.",
      cards: [
        { name: "Primavera", highlight: "Verde, Isonzo in piena e prime escursioni." },
    ...
    location: {
      title: "Dove trovarci",
      body: "La casa si trova a Caporetto (Kobarid), nel cuore della Valle dell'Isonzo, circondata dalle Alpi Giulie e dal Parco Nazionale del Triglav. Bovec dista 30 minuti, Tolmino 20 minuti e Tarvisio (IT) circa un'ora di auto. L'aeroporto di Lubiana è a circa 2 ore.",
    },
    footer: {
      aboutTitle: "Chi siamo",
      aboutBody: "La casa a Caporetto è la vostra casa nel cuore delle Alpi Giulie — punto di partenza ideale per scoprire le meraviglie della Valle dell'Isonzo.",
  ...
  en: {
    ...
    gallery: {
      title: "Gallery",
      subtitle: "Photos of the house — outside and inside.",
      alts: [
        "Exterior of Cottage Kobarid holiday house with terrace and garden by the forest",
        "Entrance to the Kobarid holiday house with flowers and outdoor seating",
        "Aerial view of Cottage Kobarid holiday house and garden terraces",
        "Aerial view of the holiday house in Kobarid with the upper terrace",
        "View of the Kobarid holiday house and valley with surrounding mountains",
        "View from the holiday house in Kobarid towards the mountains and nearby homes",
        "Upper garden terrace of the Kobarid holiday house with sun lounger and steps",
        "Garden lounge area and outdoor barbecue by the holiday house in Kobarid",
        "Covered terrace of Cottage Kobarid holiday house with dining table and chairs",
        "Pergola lounge by the Kobarid holiday house with mountain views",
        "Outdoor fire pit by the Kobarid holiday house with a view over the Soča Valley",
        "Upper viewing terrace of Cottage Kobarid holiday house with wooden chairs",
        "Dining area and kitchen inside Cottage Kobarid holiday house",
        "Living area of the Kobarid holiday house with dining table, benches and corner sofa",
        "Bright living space in the holiday house in Kobarid with a wooden dining table",
        "Living area of Cottage Kobarid holiday house with stairs to the attic",
        "Compact kitchen in the holiday house in Kobarid with induction hob and oven",
        "Modern kitchen in Cottage Kobarid holiday house with wooden finishes",
        "Bathroom in the holiday house in Kobarid with sink and toilet",
        "Washing machine in the bathroom of Cottage Kobarid holiday house",
        "Attic bedroom in the holiday house in Kobarid with four beds",
        "Attic bedroom in Cottage Kobarid holiday house with multiple beds and a baby cot",
        "Loft bedroom in the Kobarid holiday house with single and double beds",
        "Family attic bedroom in Cottage Kobarid holiday house",
      ],
    },
    hero: {
      title: "Cottage Kobarid",
    ...
    about: {
      ...
      body3: "On the ground floor a spacious living area welcomes you with a comfortable corner sofa, a dining table with benches and an air conditioner that keeps the temperature pleasant year round. The kitchen is fully equipped for preparing meals and includes a dishwasher, induction hob, oven, extractor hood, water heater and fridge with freezer.",
      body4: "The bathroom is equipped with a shower, washbasin, WC, washing machine, hairdryer and electric water heater.",
      body5: "The attic offers two comfortable double beds (150 × 200 cm) and one single bed (90 × 200 cm), allowing a comfortable stay for up to five people. For extra comfort the room features an air conditioner, a wardrobe and a baby cot, making the accommodation suitable for families with small children too.",
      body6: "For pleasant gatherings outdoors there is a covered terrace at the back of the house, a pergola with a seating set in front, an outdoor grill and a fire pit area. On the upper terrace, you can enjoy your morning coffee or an evening sunset surrounded by pristine nature and breathtaking views.",
      body7: "Kobarid and its surroundings offer numerous opportunities for an active holiday: bike rental, rafting, canyoning, paragliding, fishing and much more. Lovers of a quieter break can explore forest trails or cool off in the nearby Nadiža river.",
  ...
  de: {
    ...
    gallery: {
      title: "Galerie",
      subtitle: "Fotos des Hauses — außen und innen.",
      alts: [
        "Außenansicht des Ferienhauses Cottage Kobarid mit Terrasse und Garten am Waldrand",
        "Eingang des Ferienhauses Kobarid mit Blumen und Sitzplätzen vor dem Haus",
        "Luftaufnahme des Ferienhauses Cottage Kobarid und der Gartenterrassen",
        "Luftaufnahme des Ferienhauses in Kobarid mit oberer Aussichtsterrasse",
        "Blick auf das Ferienhaus Kobarid und das Tal mit den umliegenden Bergen",
        "Ausblick vom Ferienhaus in Kobarid auf Berge und umliegende Häuser",
        "Obere Gartenterrasse des Ferienhauses Kobarid mit Liegestuhl und Treppen",
        "Garten-Lounge und Außen-Grill am Ferienhaus in Kobarid",
        "Überdachte Terrasse des Ferienhauses Cottage Kobarid mit Tisch und Stühlen",
        "Pergola mit Sitzgruppe am Ferienhaus Kobarid und Blick auf die Berge",
        "Feuerstelle am Ferienhaus Kobarid mit Blick über das Soča-Tal",
        "Obere Aussichtsterrasse des Ferienhauses Cottage Kobarid mit Holzstühlen",
        "Essbereich und Küche im Ferienhaus Cottage Kobarid",
        "Wohnbereich des Ferienhauses Kobarid mit Esstisch, Bänken und Ecksofa",
        "Heller Wohnraum im Ferienhaus in Kobarid mit Holzesstisch",
        "Wohnbereich des Ferienhauses Cottage Kobarid mit Treppe ins Dachgeschoss",
        "Kompakte Küche im Ferienhaus in Kobarid mit Induktionskochfeld und Backofen",
        "Moderne Küche im Ferienhaus Cottage Kobarid mit Holzoberflächen",
        "Badezimmer im Ferienhaus in Kobarid mit Waschbecken und WC",
        "Waschmaschine im Badezimmer des Ferienhauses Cottage Kobarid",
        "Dachgeschoss-Schlafzimmer im Ferienhaus in Kobarid mit vier Betten",
        "Dachgeschoss-Schlafzimmer im Ferienhaus Cottage Kobarid mit mehreren Betten und Babybett",
        "Schlafzimmer im Dachgeschoss des Ferienhauses Kobarid mit Einzel- und Doppelbetten",
        "Familienzimmer im Dachgeschoss des Ferienhauses Cottage Kobarid",
      ],
    },
    hero: {
      title: "Cottage Kobarid",
    ...
    about: {
      ...
      body3: "Im Erdgeschoss erwartet Sie ein geräumiger Wohnbereich mit einer bequemen Ecksofagarnitur, einem Esstisch mit Bänken sowie einer Klimaanlage, die das ganze Jahr über eine angenehme Temperatur sorgt. Die Küche ist für die Zubereitung von Mahlzeiten voll ausgestattet und umfasst Geschirrspüler, Induktionskochfeld, Backofen, Dunstabzugshaube, Warmwasserbereiter sowie Kühlschrank mit Gefrierfach.",
      body4: "Das Badezimmer ist mit Dusche, Waschbecken, WC, Waschmaschine, Haartrockner und elektrischem Warmwasserbereiter ausgestattet.",
      body5: "Im Dachgeschoss stehen zwei bequeme Doppelbetten (150 × 200 cm) sowie ein Einzelbett (90 × 200 cm) zur Verfügung, was einen komfortablen Aufenthalt für bis zu fünf Personen ermöglicht. Für zusätzlichen Komfort befinden sich im Raum eine Klimaanlage, ein Kleiderschrank und ein Kinderbett, sodass die Unterkunft auch für Familien mit Kleinkindern geeignet ist.",
      body6: "Für gemütliches Beisammensein im Freien stehen eine überdachte Terrasse hinter dem Haus, eine Pergola mit Sitzgarnitur vor dem Haus, ein Außengrill sowie ein Sitzbereich am Feuer zur Verfügung. Auf der oberen Terrasse können Sie bei Morgenkaffee oder Abendsonnenuntergang unberührte Natur und atemberaubende Aussichten genießen.",
      body7: "Kobarid und seine Umgebung bieten zahlreiche Möglichkeiten für aktive Freizeitgestaltung: Fahrradverleih, Rafting, Canyoning, Gleitschirmfliegen, Angeln und vieles mehr. Liebhaber ruhigerer Erholung können Waldwege erkunden oder sich im nahen Fluss Nadiža erfrischen.",
